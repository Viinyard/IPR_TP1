...
public class ServeurTCP {
    ...
    public static void traiterSocketCliente(Socket socketVersUnClient, String socket) {
        //Créer printer et reader
    	try {
			BufferedReader reader = ServeurTCP.creerReader(socketVersUnClient, socket);
			PrintWriter printer = ServeurTCP.creerPrinter(socketVersUnClient, socket);
